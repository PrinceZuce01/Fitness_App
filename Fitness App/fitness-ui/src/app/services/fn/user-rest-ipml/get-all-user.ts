...
export function getAllUser(http: HttpClient, rootUrl: string, params?: GetAllUser$Params, context?: HttpContext): Observable<StrictHttpResponse<Array<UserWrapper>>> {
